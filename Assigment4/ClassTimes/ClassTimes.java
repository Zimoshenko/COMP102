...
public class ClassTimes {
      ...
      public void printCourse(String targetCourse){
           ...
           try {
            ...
            while(scan.hasNext()){
                ...
                if(targetCourse.equals(courseCode)){
                    UI.println(courseCode +" "+ course);
                      }
            }
            UI.println("=========================");
          }catch (IOException e){
          ...
          try {
            ...
            while (scan.hasNext()){
             ...
             if(room.equals(targetRoom)){
                UI.println(code + " on "+day +" starting "+startTime);
                }
             }
             scan.close();
            }catch  (IOException e){
           ...
           try{
            ...
            while (scan.hasNext()){
             ...
             if((room.equals(targetRoom1)||room.equals(targetRoom2))&&day.equals(targetDay)){
                UI.println(code+""+classType+" "+day+" "+startTime+" "+endTime);
                }
            }
            }catch  (IOException e){
             UI.println("File reading failed");
    ...
    public void bookingsFileForRoom(String targetRoom){
           ...
           try{
            Scanner scan = new Scanner(new File("classdata.txt"));
            String filename = targetRoom + "_Bookings.txt";
            ...
            while(scan.hasNext()){
             ...
             if(room.equals(targetRoom)){
                ...
                UI.println("Time: " +day+" "+ startTime + "-" + endTime);
                UI.println("Session: " + classType);
                UI.println();
                }
            }
            }catch  (IOException e){
