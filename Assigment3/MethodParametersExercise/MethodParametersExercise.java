...
public class MethodParametersExercise {
    ...
    /** Prints a nametag (as in Lab Exercise 0)
        ...
        */
    public void printNameTag(String name,int num){
           /*# YOUR CODE HERE */
        int n =1,m=1,o=1,p=1;
          while(n<=15){
           UI.printf("- ");
        ...
        UI.println(this.printNameTag("John Smith", 325));
        while(m<=6){
            UI.println("|");
            m=m+1;
        }
    ...
    /** bottleSongVerse
        ...
        */
    public void bottleSongVerse(int a ){
           /*# YOUR CODE HERE */
    ...
    public void drawCross(double xo,double yo,double s ,double t ){
           /*# YOUR CODE HERE */
